...
class Storage extends BaseStorage implements StorageInterface
{
    ...
    protected function setDefaults()
    {
        ...
        if ($fileRoot !== false) {
            ...
            $this->documentRoot = $_SERVER['DOCUMENT_ROOT'];
            $this->storageRoot = dirname((string) $_SERVER['SCRIPT_FILENAME'], 3) . '/' . $this->defaultDir;
        }
     ...
     * @return bool
     */
    public function copyRecursive($source, $target): bool
    {
     ...
     * @return bool
     */
    public function renameRecursive($source, $target): bool
    {
     ...
     * @return bool
     */
    public function unlinkRecursive($target): bool
    {
        $targetPath = $target->getAbsolutePath();
